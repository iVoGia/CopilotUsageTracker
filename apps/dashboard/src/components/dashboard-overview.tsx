  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <Stat label="Credits" value={t.credits.toFixed(2)} />
        ...
        <Stat label="Input tokens" value={t.inputTokens} />
      ...
      <section className="grid gap-6 lg:grid-cols-2">
        ...
        <ChartPanel title="Credits trend">
          <ResponsiveContainer width="100%" height={240}>
      ...
      <section className="grid gap-6 lg:grid-cols-2">
        <SimpleTable
          title="Top users"
          columns={['Developer', 'Prompts', 'Credits']}
